...
CREATE TABLE `applications`  (
  ...
  `job_id` int NOT NULL,
  `user_id` bigint NOT NULL COMMENT '申请人用户ID，关联users表',
...
CREATE TABLE `assistance_records`  (
  ...
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT 'pending' COMMENT '状态：pending-待处理, in_progress-进行中, completed-已完成, cancelled-已取消',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- ----------------------------
-- Table structure for resume_guidance_appointments
-- ----------------------------
DROP TABLE IF EXISTS `resume_guidance_appointments`;
CREATE TABLE `resume_guidance_appointments`  (
  `appointment_id` bigint NOT NULL AUTO_INCREMENT,
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `teacher_id` bigint NOT NULL COMMENT '教师ID',
  `appointment_time` datetime NOT NULL COMMENT '预约时间',
  `duration` int NULL DEFAULT 60 COMMENT '时长（分钟）',
  `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '地点',
  `guidance_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '指导类型：format-格式优化, content-内容优化, comprehensive-综合指导',
  `student_resume_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '学生简历URL',
  `student_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '学生备注',
  `teacher_feedback` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '教师反馈',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT 'pending' COMMENT '状态：pending-待确认, confirmed-已确认, completed-已完成, cancelled-已取消',
  `rating` int NULL DEFAULT NULL COMMENT '学生评分（1-5）',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`appointment_id`) USING BTREE,
  INDEX `idx_resume_guidance_student_id`(`student_id` ASC) USING BTREE,
  INDEX `idx_resume_guidance_teacher_id`(`teacher_id` ASC) USING BTREE,
  INDEX `idx_resume_guidance_time`(`appointment_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_as_cs ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for mock_interview_appointments
-- ----------------------------
DROP TABLE IF EXISTS `mock_interview_appointments`;
CREATE TABLE `mock_interview_appointments`  (
  `appointment_id` bigint NOT NULL AUTO_INCREMENT,
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `teacher_id` bigint NOT NULL COMMENT '教师ID',
  `appointment_time` datetime NOT NULL COMMENT '预约时间',
  `duration` int NULL DEFAULT 60 COMMENT '时长（分钟）',
  `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '地点',
  `interview_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '面试类型：technical-技术面试, hr-HR面试, comprehensive-综合面试',
  `target_position` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '目标职位',
  `interview_mode` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT 'offline' COMMENT '面试模式：online-线上, offline-线下',
  `meeting_link` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '线上会议链接',
  `student_resume_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '学生简历URL',
  `student_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '学生备注',
  `interview_questions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '面试问题',
  `interview_feedback` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '面试反馈',
  `performance_score` int NULL DEFAULT NULL COMMENT '表现评分（0-100）',
  `strengths` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '优势',
  `weaknesses` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '不足',
  `improvement_suggestions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '改进建议',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT 'pending' COMMENT '状态：pending-待确认, confirmed-已确认, completed-已完成, cancelled-已取消',
  `rating` int NULL DEFAULT NULL COMMENT '学生评分（1-5）',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`appointment_id`) USING BTREE,
  INDEX `idx_mock_interview_student_id`(`student_id` ASC) USING BTREE,
  INDEX `idx_mock_interview_teacher_id`(`teacher_id` ASC) USING BTREE,
  INDEX `idx_mock_interview_time`(`appointment_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_as_cs ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for assistance_tracking
-- ----------------------------
DROP TABLE IF EXISTS `assistance_tracking`;
CREATE TABLE `assistance_tracking`  (
  ...
  `tracking_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '跟踪内容',
  `progress_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL DEFAULT NULL COMMENT '进展状态',
  `next_action` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NULL COMMENT '下一步行动',
  `created_by` bigint NULL DEFAULT NULL COMMENT '创建人ID',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`tracking_id`) USING BTREE,
  INDEX `idx_tracking_record_id`(`record_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_as_cs ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '应聘者笔试和面试答题统计信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `companies`  (
  ...
  `company_welfare` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '福利标签',
  `company_tags` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '公司标签',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'DISC测试记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `exam_judgment_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `task_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '笔试任务ID',
  ...
  `correct_answer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '正确答案',
  `is_correct` tinyint NULL DEFAULT NULL COMMENT '是否正确(0/1)',
  `explanation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '解释',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_task_id`(`task_id` ASC) USING BTREE,
  INDEX `idx_question_id`(`question_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '笔试判题详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `exam_question_detail`  (
  ...
  `task_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '笔试任务ID',
  `question_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '题目ID',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '题目类型(choice/true_false)',
  ...
  `answer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '正确答案',
  `explanation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '解释/陷阱提示',
  `knowledge_point` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '知识点',
  `scenario` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '场景',
  `difficulty` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '中等' COMMENT '难度',
  `trap_detection` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '陷阱提示',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_task_id`(`task_id` ASC) USING BTREE,
  INDEX `idx_question_id`(`question_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '笔试题目详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `exam_user_answer`  (
  ...
  INDEX `idx_task_id`(`task_id` ASC) USING BTREE,
  INDEX `idx_question_id`(`question_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户笔试答案表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `jobs`  (
  ...
  `verify_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'pending' COMMENT '审核状态: pending-待审核, approved-已通过, rejected-已拒绝',
  `verify_remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '审核备注/拒绝原因',
  `avg_salary` int NULL DEFAULT NULL COMMENT '平均薪资',
...
CREATE TABLE `resumes`  (
  ...
  `user_id` bigint NOT NULL COMMENT '所属用户ID，关联users表',
...
-- ----------------------------
-- Table structure for salary_prediction_result
-- ----------------------------
DROP TABLE IF EXISTS `salary_prediction_result`;
CREATE TABLE `salary_prediction_result`  (
  `pred_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `predicted_salary` decimal(10, 2) NULL DEFAULT NULL,
  `salary_range_min` decimal(10, 2) NULL DEFAULT NULL,
  `salary_range_max` decimal(10, 2) NULL DEFAULT NULL,
  `confidence_score` decimal(5, 2) NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`pred_id`) USING BTREE,
  INDEX `fk_salary_user`(`user_id` ASC) USING BTREE,
  CONSTRAINT `fk_salary_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- ----------------------------
-- Table structure for skill_association_rules
-- ----------------------------
DROP TABLE IF EXISTS `skill_association_rules`;
CREATE TABLE `skill_association_rules`  (
  `rule_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `skill_a` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `skill_b` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `support` decimal(5, 4) NULL DEFAULT NULL,
  `confidence` decimal(5, 4) NULL DEFAULT NULL,
  `lift` decimal(5, 4) NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`rule_id`) USING BTREE,
  UNIQUE INDEX `uk_skills`(`skill_a` ASC, `skill_b` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for student_employment
-- ----------------------------
DROP TABLE IF EXISTS `student_employment`;
CREATE TABLE `student_employment`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint NOT NULL COMMENT '关联用户ID（登录用户唯一标识）',
  `employment_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '就业状态：已就业/考研/考公/出国/创业/待业',
  `company_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '单位名称',
  `company_nature` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '单位性质：国企/民企/事业单位/机关/外资等',
  `company_scale` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '单位规模：大型/中型/小微',
  `industry` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '就业行业',
  `is_major_matched` tinyint NULL DEFAULT NULL COMMENT '专业是否对口 1是 0否',
  `work_province` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '工作省份',
  `work_city` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '工作城市',
  `monthly_salary` int NULL DEFAULT NULL COMMENT '税前月薪（用户填写）',
  `contract_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '签约类型：三方/劳动合同/灵活就业',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_employment_status`(`employment_status` ASC) USING BTREE,
  INDEX `idx_industry`(`industry` ASC) USING BTREE,
  INDEX `idx_work_city`(`work_city` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生就业信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `student_profile`  (
  `student_id` bigint NOT NULL AUTO_INCREMENT COMMENT '学生ID（原id字段）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_as_cs COMMENT = '学生基本信息表（仅身份信息，技能/GPA等放简历）' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试题目表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试结果主表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user_action`  (
  ...
  `action_target` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `action_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`action_id`) USING BTREE,
  INDEX `fk_action_user`(`user_id` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户答题记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `work_experience`  (
  ...
  `start_date` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `end_date` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `responsibility` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `achievement` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,

...
CREATE TABLE `question`  (
  ...
  `acceptNum` int NOT NULL DEFAULT 0 COMMENT '题目通过数',
...
CREATE TABLE `question_submit`  (
  ...
  `judgeInfo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '判题信息（json数组）',
  `status` int NOT NULL DEFAULT 0 COMMENT '判题状态（0-待判题，1-判题中，2-判题成功，3-判题失败）',
  ...
  INDEX `idx_userId`(`userId` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '题目提交表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1920859805593407491 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户' ROW_FORMAT = Dynamic;

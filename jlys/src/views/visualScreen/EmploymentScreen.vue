    ...
    <div class="dashboard-header">
      <div class="header-center-title">
        ...
        <div class="platform-info">
          <h1>就业总览大屏</h1>
          <p class="platform-desc">就业数据分析</p>
        </div>
      </div>
...
import RealtimeData from '@/ChartEmploy/RealtimeData.vue'
import collegeEmployBar from '@/ChartEmploy/collegeEmployBar.vue'
import employMajorDown from '@/ChartEmploy/employMajorDown.vue'
import EmploymentOptionPie from '@/ChartEmploy/EmploymentOptionPie.vue'
import EmployTrend from '@/ChartEmploy/EmployTrend.vue'
import IndustryFlowCount from '@/ChartEmploy/IndustryFlowCount.vue'
import EmployMap from '@/ChartEmploy/EmployMap.vue'
import SalaryRangeLine from '@/ChartEmploy/SalaryRangeLine.vue'
